(function() { // We use this anonymous function to create a closure.
	...
	app.factory('User', function($resource) {
		return $resource('http://searlew.sqrawler.com/api/users/:id.json', {}, 
		{

			'createUser': { method: 'POST', url: "http://searlew.sqrawler.com/api/users.json" },
			'updateUser': { method: 'PUT', url: 'http://searlew.sqrawler.com/api/users/:id.json' },
			'mySplatts': { method: 'GET', isArray:true, url:"http://searlew.sqrawler.com/api/users/splatts/:id.json" },
			'deleteUser': { method: 'DELETE', url: 'http://searlew.sqrawler.com/api/users/:id.json' },
			'addFollower': { method: 'POST', url:'http://searlew.sqrawler.com/api/users/follows.json' },
			'unfollow': { method: 'DELETE', url:'http://searlew.sqrawler.com/api/users/follows/:id/:follows_id'}

		});
	})

	app.factory('Splatt', function($resource) {
		return $resource('http://searlew.sqrawler.com/api/splatts/:id.json', {}, 
		{

			'createSplatt': { method: 'POST', url: "http://searlew.sqrawler.com/api/splatts.json" }
